...
Kubernetes
----------
One Helm chart to start a Hue server is available at [``tools/kubernetes/helm/hue``](tools/kubernetes/helm/hue). The Kubernetes [hue.yaml](tools/kubernetes/helm/hue/templates/hue.yaml)
